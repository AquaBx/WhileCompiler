...
void fun_add() {
    ...
    t5 = WhileStandard::copyTree(Op1);
    Result = WhileStandard::copyTree(t5);
    WhileStandard::Tree * t8 = nullptr;
    t8 = WhileStandard::copyTree(Op2);
    ...
    t24 = WhileStandard::copyTree(Result);
    t22->setHead(t23);
    t22->setTail(t24);
    Result = WhileStandard::copyTree(t22);
    *t10 += 1;
    goto label11;
    }
    label32 :
...
void fun_sub() {
    ...
    {
    WhileStandard::Tree * t22 = nullptr;
    t22 = WhileStandard::copyTree(Result);
    Result = WhileStandard::copyTree(t22);
    *t10 += 1;
    goto label11;
    }
...
void fun_not() {
    ...
    Result = WhileStandard::copyTree(t8);
    goto label21;
    }
    {
    label15 :
    ...
    Result = WhileStandard::copyTree(t16);
    }
    label21 :
    WhileStandard::getStack()->push(Result);
}
...
void fun_and() {
    ...
    fun_false();
    t14 = WhileStandard::getStack()->top(); WhileStandard::getStack()->pop();
    Result = WhileStandard::copyTree(t14);
    goto label46;
    }
    {
    label21 :
    WhileStandard::Tree * t22 = nullptr;
    t22 = WhileStandard::copyTree(Op2);
    WhileStandard::Tree * t24 = nullptr;
    ...
    Result = WhileStandard::copyTree(t31);
    goto label44;
    }
    {
    label38 :
    ...
    Result = WhileStandard::copyTree(t39);
    }
    label44 :
    }
    label46 :
...
void fun_true() {
    ...
    t1->setHead(t2);
    t1->setTail(t3);
    Result = WhileStandard::copyTree(t1);
    WhileStandard::getStack()->push(Result);
}
void fun_false() {
    WhileStandard::Tree * Result = nullptr;
